...
công cụ Tiled , được phân chia thành các phòng vơi các chức năng khác nhau trên một màn chơi.
* Hệ thống quái: được điều khiển tự động với khả năng ẩn nấp dò đường thông minh để tìm mục tiêu.
* Hệ thống các vũ khí: các vũ khí tối tân được trang bị để cho player đánh quái
...
* Trận Boss: Phòng đấu khó nhằn nhất trong cuộc chơi vơi hiệu ứng hình ảnh âm thanh đẹp mắt
* Hệ thống UFO: Cứu tinh của lũ quái triệu hồi các debuff trap gây trở ngại cho người chơi
và triệu hồi viện binh khi quái trong phong gặp khó khăn với xác suất 75%
...
đã mua trong shop, và bảng điểm cao leaderboard
